...
object TuplesAndMaps extends App{
  ...
  /*Below are the ways to create Tuples in scala
  * There are max 22 Tuple parameters*/

//  val aTuple = new Tuple2(2,"hello")
//  val aTuple = Tuple2(2,"hello")
  val aTuple = (2,"hello")

  println(aTuple._2) // the elements of tuples are accessed as _1 _2
  println(aTuple.copy(_2 = "scala"))
  println(aTuple.swap)

  // Map = keys -> values
  // Maps are immutable in Scala
  
  val aMap: Map[String, Int] = Map()

  // ways to add values in Map and withdefaultvalue will be a value displayed for any non present key
  // !!! careful with mapping keys
  val phonebook = Map(("Jim",555), "Daniel" -> 888, "JIM" -> 9000).withDefaultValue(-1)
...
//functions on maps
  ...
  /*
  Create a social network using maps
   */
